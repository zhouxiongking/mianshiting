...
<html>
  <head>
	...
	<script type="text/javascript" src="/scripts/manage/manageUser.js"></script>
  ...
  <body>
    ...
    <!-- 当前位置 -->
   	<div class="cur_postion">
   		<div class="location">
			当前位置：
			<a href="manageUserAction.action" class="location_a">用户管理</a> 
			<code>&gt; </code> 
			<a href="manageUserAction.action" class="location_a">全部用户</a> 
			<a href="showUserInfoAction" style="display: none;"><span id="toUserInfo">跳转</span></a>
		</div>
   	</div>
